...
DESKTOPCODE='../../../application/client/desktop/goodmorning_1164'
DESKTOPIMAGENAME='geppettotest/goodmorning_1164-desktop:1.0'
...
helm install --name goodmorning_1164 ./helm
if [ $? -eq 0 ]; then
